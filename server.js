  ...
  res.send(`
    ...
    <head>
      ...
      <style>
        ...
        .cta { margin-top: 40px; }
        .cta a { background: #00ffae; color: #111; padding: 15px 30px; border-radius: 10px; font-weight: bold; font-size: 18px; text-decoration: none; }
      </style>
    </head>
    <body>
      <h1>🚀 Launchpad - Tokens créés sur Alpha Hub</h1>
      <div class="cta">
        <a href="/form.html">+ Créer un token</a>
      </div>
      <div class="grid">
        ${gallery}
      </div>
